def create_categories() -> dict:
    categories = {
        'еда': ['городок', 'пятёрочка', 'ярче', 'самокат', 'продукты'],
        'транспорт': ['автобус', 'такси', 'бензин', 'самокат'],
        'развлечения': ['ресторан', 'театр', 'кино', 'концерт'],
        'здоровье': ['врач', 'лекарства', 'больница', 'глаза', 'зубы', 'аптека'],
        'дом': ['коммунальные услуги', 'Аренда квартиры', 'мебель'],
        'спорт': ['фитнес', 'йога', 'бассейн', 'зал']
    }
    return categories
